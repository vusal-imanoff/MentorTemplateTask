...
namespace MentorTemplate.Migrations
{
    ...
    [Migration("20220607221926_vuskas")]
    partial class vuskas
    {
            ...
            modelBuilder.Entity("MentorTemplate.Models.Join", b =>
                {
                    ...
                    b.HasOne("MentorTemplate.Models.Pricingss", "Pricingss")
                        .WithMany("Join")
                        .HasForeignKey("PricingssId");
                });
